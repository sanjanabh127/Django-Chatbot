...
A clean and minimal **AI-powered chatbot** built using **Django** and the **OpenAI API**.  
This project focuses on **simplicity, realistic UX**, and **secure backend integration**, without authentication or unnecessary complexity.
